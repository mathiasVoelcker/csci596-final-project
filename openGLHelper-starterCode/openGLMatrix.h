...
public:
  ...
  // static glm::mat4 GetYTranslateMatrix(float translate);
  // static glm::mat4 GetZTranslateMatrix(float translate);

  static glm::mat4 GetTransMatrix(float translateX, float translateY, float translateZ);
  static glm::mat4 GetXRotMatrix(float angle);
  static glm::mat4 GetYRotMatrix(float angle);
